...
void Employee_management::display()
{
	...
	if(!file)
	{
		cout << "\n\t\t\t No Data is Present...";
		 ...
		 cout << "\n---------------------------------------------------------------------------------------------------------------" << endl;
         cout << "\n|| NAME         ||  ID   || DESIGNATION  || AGE ||     SAL.    ||  EXP. ||";
        cout << "\n---------------------------------------------------------------------------------------------------------------" << endl;

        while (file >> name >> id >> designation >> age >> ctc >> experience)
            {
              cout << "\n";
              cout << total++ << ". " << setw(15) << left << name
                   << setw(12) << id
                   << setw(15) << designation
                   << setw(9) << age
                   << setw(15) << ctc
...
int password_user()
{
	...
	cout << "\n\t\t\t-------------------------------------------------------";
	cout << "\n\t\t\t||       WELC0ME T0 EMPL0YEE MANGEMENT SYSTEM         ||";
	cout << "\n\t\t\t-------------------------------------------------------";
